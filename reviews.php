...
$con = mysqli_connect("localhost","root","");
    ...
    $result2=mysqli_query($con,"SELECT * FROM SERIES WHERE sname='$ser'") or die (mysqli_connect_error());
    $row1=mysqli_fetch_array($result2);
    $serid1=$row1['sid'];
    $result3=mysqli_query($con,"SELECT * FROM REVIEW where movieid='$serid1'")or die (mysqli_connect_error());
...
<div class="navbar">
 ...
 <div class="container">
    ...
    echo    "<div class='reviews full-withradius border'>";
            ...
            echo "<h3>"."<b>"."<u>".$row3['caption']."</u>"."</b>"."</h3>";
   ...
   echo"</div>";
    ...
    <form action="addreviews.php" method="get" >
         <?php echo"<button type='submit' style='margin-left:600px' name='mid' value='".$row1['sid']."'>Add Review</button>";?>
        </form>
